...
<section id="fv" class="fv">
  <div class="content__wrap">
    ...
    <h2 class="main__copy y bold">自然の恵みを感じ、<br class="sp__only">豊かな未来を。</h2>
  </div>
  <div class="pickup__news a">
...
<section id="works" class="activity">
  <div class="activty__wrap y">
    <div class="section__ttl__wrap">
      <h2 class="section__ttl bold">活動紹介</h2>
    </div>
    <!-- タブ -->
    <ul class="tab__area">
    ...
    <div class="panel active">
      <p class="tab__txt">私たちは、「持続可能な農業」を掲げて、自然の恵みに感謝しながら、農作物を育てています。<br>無農薬で、体にも環境にも優しく、季節ごとに異なる品種を育て、提供しています。
...
<section id="news" class="news">
  <div class="news__wrap flex-c">
    <div class="news__main">
      ...
      <p class="news__top__desc y">季節の農作物のお知らせ、見学ツアーのご案内、<br class="pc__only">オンライン販売セールのお知らせなど、自然の恵み農園の最新情報をお届けします。
      </p>
    </div>
      ...
      ?>
        <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
          ...
          <li class="news__article__item">
            <div class="flex-c">
              <div class="date a"><?php echo get_the_date(); ?></div>
            ...
            <div class="news__content y bold">
    ...
    <div class="content__area">
      <div class="content__inner y">
        ...
        <dl class="inner__item flex-s map">
          <dt>Googleマップ
            <div class="scale-up y bold"><a href="https://maps.app.goo.gl/PfVhTdfTYgQUNJn88">拡大地図を表示</a></div>
          </dt>
...
<section id="contact" class="contact">
  <div class="wrap">
    ...
    <a class="contact__btn y" href="<?php echo home_url("contact"); ?>">
